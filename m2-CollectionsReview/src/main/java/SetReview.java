...
public class SetReview {
    public static void main(String[] args) {
      ...
      Set<Student> set =new LinkedHashSet<>();
        ...
        set.add(new Student(4,"Mary")); // you have to override the hashCode inside Student to work Set properly
    ...
    public static Character firstRepeatingChar(String str){
        ...
        for(Character ch:str.toCharArray()) if (!chars.add(ch)) return ch; // add method also return boolean
